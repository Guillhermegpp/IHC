...
def index(request):
    ...
    if update.message.text == "/start":
        bot.sendMessage(chat_id=update.message.chat_id, text = "Digite o nome da cidade e o estado após um hífem: \nExemplo: Sao Paulo - SP")
    else:
        update = telegram.update.Update.de_json(json.loads(request.body),bot)
